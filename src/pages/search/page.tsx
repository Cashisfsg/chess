    ...
    return (
        <main className="grid flex-auto grid-rows-[auto_1fr_auto] gap-y-8">
            ...
            <section className="grid place-content-center gap-y-4">
                ...
                <CreateLobbyButton className="flex items-center justify-center gap-x-4 rounded-2xl bg-black/30 px-6 py-4 shadow-lg transition-colors duration-150 active:bg-white/15">
                    <svg
                        width="55"
                        height="55"
                        fill="none"
